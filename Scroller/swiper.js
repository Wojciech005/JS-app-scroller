class swiper {
    constructor() {
        ...
        document.addEventListener('touchstart', (event) => this.startTouch)
        document.addEventListener('touchmove', (event) => this.moveTouch)
    ...
    startTouch(event) {
        ...
        moveTouch(event) {
            ...
            const currentX = event.touch[0].clientX;
            const currentY = event.touch[0].clientY;
