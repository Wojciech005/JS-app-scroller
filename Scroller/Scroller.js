class Scroller {
    constructor(rootSelector) {
        ...
        const currentSectionIndex = sectionArr.findIndex(this.isScrollIntoWiev);

        // this.currentSectionIndex = currentSectionIndex < 0 ? 0 : currentSectionIndex;
        this.currentSectionIndex = Math.max(currentSectionIndex, 0)

        this.isThorttled = false;
        
    //    this.isScrollIntoWiev(this.sections[0])
    ...
    listenScroll = (event) => {
        if (this.isThorttled) return;
        this.isThorttled = true;
